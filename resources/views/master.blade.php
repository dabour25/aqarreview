...
<header class="main-header fixed-header-2">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <ul class="navbar-nav header-ml">
					...
					<li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="/reg">تسجيل</a></li>
                            @else
            ...
            <a class="lang tinylang" href="/addnew">أضف إعلان</a>
    ...
    <div class="container footer-inner">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <p class="copy sub-footer">© {{Date('Y')}} All Right Reserved- Developed By: <a href="https://www.facebook.com/dabour25" target="blanck">Ahmed Magdy</a></p>
            </div>
        </div>
    </div>
</footer>
...
<header class="main-header fixed-header-2">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="lang tinylang" href="/addnew">Add Advertise</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
